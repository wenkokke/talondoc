...
@staticmethod
def register(topic: Union[int, str], cb: Callable) -> None:
    global current_python_dynamic_file_analysis
    current_python_dynamic_file_analysis.register(topic, cb)


@staticmethod
def unregister(topic: Union[int, str], cb: Callable) -> None:
    global current_python_dynamic_file_analysis
    current_python_dynamic_file_analysis.unregister(topic, cb)


Register = type("Register", (object,), {"register": register, "unregister": unregister})
